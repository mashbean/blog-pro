...
頁面預設進入全台總覽，可依區域、A／B／C 級與關鍵字篩選。每張城市卡除了歲入、歲出、資本支出與前三大政事別，也顯示 OpenFun 最新年度、工作計畫列數、Twinkle 是否命中全市總預算，以及一個資料驅動的查證問題。全台頁新增雙接口成績、六項值得追問訊號與 22 縣市驗收表。CSV 也加入融資、以前年度賸餘、服務命中與來源欄位。
