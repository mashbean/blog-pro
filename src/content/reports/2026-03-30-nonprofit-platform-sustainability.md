...
**台灣的 PTT** 是全球歷史最悠久的非營利社群平台之一。1995 年由杜奕瑾在台灣大學創立，以大學基礎設施補貼營運成本，由學生志願者維護，三十年來沒有廣告，沒有訂閱費，沒有演算法推送。2014 年太陽花運動期間，PTT 同時在線人數達到歷史高峰的 177,734 人，平日晚間也常態超過十萬人。但這個數字已經回不去了。根據風傳媒的報導，近年同時在線人數已跌至約五萬人左右，相比高峰期萎縮了超過七成。2018 年 9 月，PTT 因假帳號氾濫暫停新用戶註冊，至今未重新開放，等於凍結了使用者基數的增長。在此期間，Dcard 趁勢超越 PTT 的網站流量排名，成為台灣年輕世代的主要社群平台。

PTT 的治理也反映了非營利平台的典型困境。2006 年，當 PTT 同時在線突破五萬人時，站務團隊曾希望將 PTT 法人化並把伺服器搬離台大。台大校方則試圖成立委員會接管 PTT，將其視為校方資產。杜奕瑾以「父子關係而非從屬關係」為由抗拒，甚至表示將「把機器搬走」。這場危機最終不了了之，但反映了一個結構性問題——PTT 既不是台大的正式單位，也沒有獨立法人身份，治理架構懸在灰色地帶。杜奕瑾自 2017 年創辦台灣人工智慧實驗室後，已不再參與 PTT 的日常營運。一個三十年的平台，其存續仍然依賴台大的善意與一群不斷換屆的學生志願者。純文字介面限制了成長，但也壓低了成本——沒有前端技術債的迭代壓力，也沒有媒體內容帶來的儲存成本爆炸。PTT 的永續邏輯成立，但它的退潮也是真實的。

**g0v（零時政府）** 代表了另一種路徑，一個沒有正式法人實體的去中心化公民科技社群。2012 年至今已舉辦超過 65 場黑客松，累計參與者超過 7,000 人次，每場至少 100 人以上，超過六成參與者並非技術背景。財務代管由開放文化基金會（OCF）處理，OCF 到 2023 年已成長至 17 名全職員工，支援 43 個社群。唐鳳即出身這個社群。

但 g0v 最具標誌性的專案 vTaiwan 的衰退，是公民科技永續性最具教育意義的案例之一。vTaiwan 在太陽花運動後啟動，曾讓超過 20 萬人參與 26 項國家立法的意見形成。然而自 2018 年以來，vTaiwan 再也沒有被用於任何重大政策決議。共同發起人許毓仁（前立法委員）指出，政府「沒有義務採納 vTaiwan 的建議」，使得立法者不認真對待這個平台。行政院隨後推出了競爭性的「Join」平台，進一步邊緣化了 vTaiwan。一位執政黨立委曾坦言 vTaiwan「不是高度優先事項」，而且曾「接近死亡」。COVID 疫情中斷了維繫 vTaiwan 社群的每週實體聚會，加速了退潮。g0v 的黑客松仍然持續舉辦，社群並未消失，但其旗艦專案的命運說明了一個殘酷的現實——志願勞動與社群認同可以啟動專案，但無法在政府採納意願消退時維持專案的影響力。
...
這些亞洲案例指向一組與歐美不同的永續條件，包括機構補貼（PTT）、志願勞動與社群認同（g0v）、文化語境中的個人捐款（Misskey）、區塊鏈經濟模型（Matters）。但每一個都已經或正在經歷退潮。PTT 的同時在線從十七萬跌到五萬，註冊凍結七年。g0v 的旗艦專案 vTaiwan 自 2018 年起實質停擺。Misskey 在爆發式成長中暴露了單人依賴的脆弱性。Matters 的代幣經濟基礎已經崩塌了 97%。「有效」和「永續」之間的距離，比任何一個開始的時刻看起來都要遠。
...
- **Meinrath, S.D., Losey, J. & Pickard, V. (2011).** "Digital Feudalism: Enclosures and Erasures from Digital Rights Management to the Digital Divide." *CommLaw Conspectus*, 19(2). ([全文](https://scholarship.law.edu/commlaw/vol19/iss2/6/)) — 以「數位封建主義」為題的早期重要學術論文，援引哈伯馬斯理論分析網路守門人化。
...
- **Mozilla Foundation (2023).** "A Practical Framework for Applying Ostrom's Principles to Data Commons Governance." ([文章](https://www.mozillafoundation.org/en/blog/a-practical-framework-for-applying-ostroms-principles-to-data-commons-governance/)) — 將 Ostrom 原則直接套用到數位公共財的實務框架。
- **Scholz, T. (2016).** "Platform Cooperativism: Challenging the Corporate Sharing Economy." Rosa Luxemburg Stiftung. ([PDF](https://rosalux.nyc/wp-content/uploads/2020/11/RLS-NYC_platformcoop.pdf)) — 平台合作主義的核心理論文本。
...
- **Wikimedia Foundation.** FY2024-2025 Audit Report. ([財務報告頁](https://wikimediafoundation.org/about/financial-reports/)) — 基金會年度審計報告，為 Wikipedia 收入、捐款、員工數等數字的主要來源。
- **Wikimedia Endowment.** FY2024-2025 Report. ([基金會頁面](https://wikimediaendowment.org/)) — 捐款基金規模與增長數據。
- **Signal Technology Foundation.** IRS Form 990, via ProPublica Nonprofit Explorer. ([查詢](https://projects.propublica.org/nonprofits/organizations/824506840)) — Signal 的收入、支出、淨資產、Acton 貸款等財務數據的法定申報來源。
- **Mozilla Foundation.** Audited Financial Statements. ([財務報告](https://foundation.mozilla.org/en/about/financial-reports/)) — Mozilla Corporation 與 Foundation 的收入結構、Google 搜尋合約佔比。Mitchell Baker 薪酬數據來自 IRS Form 990。
- **Internet Archive.** IRS Form 990, via ProPublica Nonprofit Explorer. ([查詢](https://projects.propublica.org/nonprofits/organizations/943242767)) — Internet Archive 的年度收支數據。
- **Mastodon gGmbH.** Annual Report 2024. ([Blog](https://blog.joinmastodon.org/)) — Mastodon 的收入、非營利資格喪失、基金會轉型等資訊的主要來源。
- **Stocksy United.** ([官網](https://www.stocksy.com/)) — 版稅比例（標準 50%、延伸 75%）的來源。
...
- **Raman, A. et al. (2024).** "An evidence-based and critical analysis of the Fediverse decentralization promises." arXiv:2408.15383. ([論文](https://arxiv.org/abs/2408.15383)) — 分析 Fediverse 實際用戶分布，發現活躍用戶高度集中在少數節點，聯邦化並未阻止權力集中。
- **Kazemi, D. (2019).** "Run Your Own Social." ([runyourown.social](https://runyourown.social/)) — 小型 Mastodon 實例（50-100 人）的營運經驗與成本記錄。
- **FediPact.** ([fedipact.online](https://fedipact.online/)) — 800+ 節點管理者承諾封鎖 Threads 的聯署行動。
- **FediDB.** ([fedidb.org](https://fedidb.org/)) — Fediverse 實例統計資料庫。注意：FediDB 於 2025 年 2 月 6 日暫停所有爬蟲抓取。
...
- **Schneider, N. (~2020).** Exit to Community. ([e2c.how](https://e2c.how/)) — 主張新創企業規劃將所有權移轉給社群的概念。
- **Purpose Foundation.** ([purpose-economy.org](https://purpose-economy.org/)) — 推動管家所有權（steward ownership）結構。
- **Patagonia / Holdfast Collective (2022).** — 管家所有權的里程碑案例。

### 公共資金

- **NLnet Foundation.** ([nlnet.nl](https://nlnet.nl/)) — 透過 NGI Zero 計畫資助超過 400 個開源 / Fediverse 專案，每年分配約 €10-15M。
- **NGI (Next Generation Internet).** EU Horizon 2020/Europe 計畫。— 2024 年面臨預算草案未納入後續資金的危機。
- **Sovereign Tech Fund / Agency (Germany).** ([sovereign.tech](https://sovereigntechfund.de/)) — 德國聯邦經濟事務部下設，初始預算 €11.5M，資助核心開源基礎設施。
- **Zuckerman, E. (2020).** "The Case for Digital Public Infrastructure." Knight First Amendment Institute / Columbia Journalism Review. ([Initiative](https://publicinfrastructure.org/)) — 公共廣播→公共數位平台類比的核心論述。

### 亞洲平台

- **PTT 看板人數紀錄.** PTT Fandom Wiki. ([頁面](https://pttpedia.fandom.com/zh/wiki/%E7%9C%8B%E6%9D%BF%E4%BA%BA%E6%95%B8%E3%80%81%E7%9C%8B%E6%9D%BF%E4%BA%BA%E6%B0%A3)) — 2014 年太陽花運動期間 177,734 人同時在線的紀錄。
- **風傳媒 (Storm Media).** PTT 使用者流量分析報導. ([文章](https://www.storm.mg/lifestyle/4750284)) — PTT 同時在線人數下滑至約五萬人的報導。
- **Statista.** Taiwan PTT Bulletin Board System Daily Visits. ([數據](https://www.statista.com/statistics/1345506/taiwan-ptt-bulletin-board-system-daily-visits/)) — 2024 年 6 月 PTT 日訪問量數據。
- **遠見雜誌 (Global Views).** Dcard 超越 PTT 流量排名報導. ([文章](https://www.gvm.com.tw/article/72431)) — PTT 註冊凍結期間 Dcard 流量超越的報導。
- **VERSE.** 杜奕瑾專訪. ([文章](https://www.verse.com.tw/article/my-way-ethan-tu)) — 2006 年台大治理危機及杜奕瑾對 PTT 與台大關係的描述。
- **g0v Jothon.** ([jothon.g0v.tw](https://jothon.g0v.tw/about/en/)) — g0v 黑客松累計場次、參與人數、社群規模等官方數據。
- **OCF (Open Culture Foundation).** 2023 Annual Report. ([ocf.tw](https://ocf.tw/en/p/2023/)) — OCF 員工數、支援社群數等數據。
- **The Daily Beast.** "Taiwan Tried to Digitize Democracy With vTaiwan. It Was a Huge Flop." ([文章](https://www.thedailybeast.com/taiwan-tried-to-digitize-democracy-with-vtaiwan-it-was-a-huge-flop/)) — vTaiwan 自 2018 年後實質停擺的調查報導，包含許毓仁及執政黨立委的引述。
- **Fediverse Report.** Misskey 2023 Recap. ([文章](https://fediversereport.com/misskey-2023-recap/)) — Misskey.io 用戶成長數據、syuilo 關於捐款極限的公開發言、管理者對財務前景的擔憂。
- **Nikkei Asia.** "Post-Twitter Decentralized Social Media Struggles for Way Forward." — Misskey 在 Twitter/X 遷移潮中的成長與挑戰。
- **CoinGecko.** LikeCoin Price Data. ([頁面](https://www.coingecko.com/en/coins/likecoin)) — LikeCoin 歷史價格（ATH $0.059 → ATL $0.00084，跌幅超過 97%）。
- **Tracxn / PitchBook.** Matters Lab Company Profile. ([Tracxn](https://tracxn.com/d/companies/matters-lab/__rxLlUf8WSqdM_L7gmO4iuu06rpd_drmCUirA7vNyLQI)) — Matters Lab 融資總額約 $2M 的來源。
- **Freedom House.** "Impact of the National Security Law on Media and Internet Freedom in Hong Kong." ([報告](https://freedomhouse.org/article/impact-national-security-law-media-and-internet-freedom-hong-kong)) — 《國安法》對香港公民社會的影響，作為 Matters 抗審查定位的背景。
