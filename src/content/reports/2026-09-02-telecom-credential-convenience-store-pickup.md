...
_這是「有備而來：理想的數位皮夾開發報告」第二篇。分析材料包括 iPhone 真機操作、正式門市 POS 驗收、數位發展部公開程式碼與 QR 驗證規格、OpenID4VP 1.0 Final，以及國外官方案例。公開截圖保留發卡者的 `did:key` 與信任紀錄，姓名、手機末五碼、憑證序號和可掃描 QR 均已遮蔽。_
