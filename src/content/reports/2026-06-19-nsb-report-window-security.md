...
aiPipelineId: "research-publishing-pipeline/2026-06-19-defector-first-contact-revision"
...
1. 本地 NSB 低侵入實測與上一版 evidence map。revision job `raw/previous-evidence/evidence-map-v2.md`、`raw/previous-evidence/fact-check-report-v2.md`、`raw/previous-version/article-final-v2.md`。封存日期 2026-06-19。
